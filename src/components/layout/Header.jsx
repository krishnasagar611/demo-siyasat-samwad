  ...
  const deleteAccount = async e => {
    ...
    confirm({
      ...
      content: (
        <>
          <p>
            Are you sure you want to delete your account? This action cannot be undone.By deleting your account, you
            will lose access to:
          </p>
        ...
        <div className='navbar_content'>
          <div id='News-logo' className='News-logo'>
            <Link href='/' activeclassname='active' exact='true'>
              <img
                id='NewsLogo'
                src={settings && settings?.web_setting?.web_header_logo}
          ...
          <div className='Manu-links'>
            <ul className=''>
              ...
              {settings &&
              settings.live_streaming_mode === '1' &&
              checkNewsData &&
              checkNewsData?.data?.isLiveNewsData ? (
                <li id='NavHover' className='nav-item'>
                  <b>
                    <Link
                      id='nav-links'
              ...
              {settings &&
              settings.breaking_news_mode === '1' &&
              checkNewsData &&
              checkNewsData?.data?.isBreakingNewsData ? (
                <li id='NavHover' className='nav-item'>
                  <b>
                    <Link
                      id='nav-links'
