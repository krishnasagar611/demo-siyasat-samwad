...
import { getNewsApi } from '../../../hooks/newsApi.jsx'
import { getAdsSpaceNewsDetailsApi } from '../../../hooks/adSpaceApi'
import Layout from '../../../components/layout/Layout.jsx'
import toast from 'react-hot-toast'
import Surveys from '../../../components/survey/Surveys.jsx'
import AdSpaces from '../../view/adSpaces/AdSpaces.jsx'
import { Col, Container, Row } from 'react-bootstrap'
import Link from 'next/link.js'
import Sidebar from '../../../components/features-Style/SideMenu.tsx'
import ArticleCard from '../../../components/features-Style/AddNews.tsx'
                ...
                <div className='news-deatail-section'>
                  <div id='nv-main' className='container news_detail'>
                    ...
                    {sponsoredads && sponsoredads.ad_spaces_top ? (
                      <>
                        <AdSpaces
                          ad_url={sponsoredads && sponsoredads.ad_spaces_top.ad_url}
                          ad_img={sponsoredads && sponsoredads.ad_spaces_top.web_ad_image}
                          style_web=''
                        />
                      </>
                    ) : null}
                    <div id='nv-page' className='row'>
                      <div id='nv-body' className='col-lg-12 col-12'>
                        ...
                        <div id='nv-Header' className=''>
                          <div id='nv-left-head'>
                            <p id='head-lables'>
                              ...
                              {new Date(Data && Data[0]?.date).toLocaleString('en-us', {
                                day: 'numeric',
                                month: 'short',
                                year: 'numeric'
                              })}
                            ...
                            {/* <p id='head-lables'>
                              <AiOutlineLike size={18} id='head-logos' /> {Data && Data[0]?.total_like}{' '}
                              {translate('likes')}
                            </p> */}
                    ...
                    {sponsoredads && sponsoredads.ad_spaces_bottom ? (
                      <>
                        <AdSpaces
                          ad_url={sponsoredads && sponsoredads.ad_spaces_bottom.ad_url}
                          ad_img={sponsoredads && sponsoredads.ad_spaces_bottom.web_ad_image}
                          style_web=''
                        />
                      </>
                    ) : null}
