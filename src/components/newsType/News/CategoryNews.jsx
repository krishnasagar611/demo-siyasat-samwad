...
import { formatDate, placeholderImage, NoDataFound } from '../../../utils'
...
import LoadMoreBtn from '../../../components/view/adSpaces/loadMoreBtn/LoadMoreBtn'
import { Col, Container } from 'react-bootstrap'
import { Row } from 'antd'
import Sidebar from '../../../components/features-Style/SideMenu'
import NewsFeed from '../../../components/features-Style/NewsFeed'
import AddNews from '../../../components/features-Style/AddNews'
...
const CategoryNews = () => {
  ...
  useEffect(() => {
    if (Data && Data.data) {
      loadMore ? setCategoriesNewsData(prevData => [...prevData, ...Data.data]) : setCategoriesNewsData(Data.data)
    }
  }, [Data])
                  ...
                  <>
                    <Container>
                      <Row>
                        ...
                        <Col md={7}>
                          <div className='col-lg-6 col-md-4 col-12 p-2' key={element.id}>
                            <Link
                              id='Link-all'
                              href={{
